...
namespace ZendeskApi_v2.Requests.HelpCenter
{
    ...
    public class Articles : Core, IArticles
    {
        ...
        public Articles(string yourZendeskUrl, string user, string password, string apiToken, string locale, string p_OAuthToken, Dictionary<string, string> requestHeaders)
